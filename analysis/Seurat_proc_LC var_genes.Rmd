...
```{r filter}
Loco <- subset(Loco, subset = nFeature_RNA > 200 & nFeature_RNA < 6500 & percent.mt < 20)
plot1 <- FeatureScatter(Loco, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(Loco, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
plot1 + plot2
```
...
```{r glutamate marker}
FeaturePlot(Loco, slot = "scale.data", features = c("Slc17a7", "Slc18a2", "Slc17a6", "Gad2", "Piezo2", "Stat2", "Snap25", "Syt1", "Stx1a", "Syp"), order = T)
```
...
```{r neuronal subset}
Locon <- subset(Loco, idents = c(1,4,5,8,10,11,13))
